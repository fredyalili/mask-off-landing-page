      ...
      <div className="container mx-auto px-4">
        <div className="max-w-xl mx-auto text-center">
          ...
          {/*
            ...
            On a successful signup the user is also sent to /maskless-founder
            automatically (see BeehiivSignup's postMessage listener).
          */}
          ...
          <p className="text-muted-foreground/80 text-sm mt-6 text-balance">
            After you sign up, you&apos;ll have the option to become a $1 Maskless Founder and
            unlock the Maskless Card benefit.
          </p>
        </div>
      </div>
    </section>
